...
require("neo-tree").setup({
  ...
  default_component_configs = {
    ...
    diagnostics = {
      ...
      highlights = {
        error = "DiagnosticSignError", -- Resaltado para errores
        warn = "DiagnosticSignWarn",   -- Resaltado para advertencias
        info = "DiagnosticSignInfo",   -- Resaltado para información
        hint = "DiagnosticSignHint",   -- Resaltado para sugerencias
      },
    },
    icon = {
      folder_closed = "",
